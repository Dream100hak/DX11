...
void SimpleGrid::Create(int32 sizeX, int32 sizeZ, shared_ptr<Material> material)
{
	_sizeX = sizeX;
	_sizeZ = sizeZ;
...
bool SimpleGrid::Pick(int32 screenX, int32 screenY, Vec3& pickPos, float& distance)
{
