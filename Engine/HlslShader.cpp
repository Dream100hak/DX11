...
// --------------------------------------------------------------------------
// Internal : VS Blob ���÷������κ��� InputLayout �ڵ� ����
// --------------------------------------------------------------------------
void HlslShader::CreateInputLayoutFromVS(ComPtr<ID3DBlob> vsBlob)
{
	...
	for (UINT i = 0; i < shaderDesc.InputParameters; i++)
	{
		...
		// INST* (Instancing) �Ǵ� PICKED�� InputSlot 1�� �Ҵ�
		...
		// INST_WORLD (matrix): 4���� float4�� ���� ? ���÷����� index 0~3�� ���� ������
		// index 0���� �� ���� 4���� �߰��ϰ�, ������ index(1~3)�� ��ŵ
		if (name == "INST_WORLD")
		{
