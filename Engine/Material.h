...
public:
	...
	ComPtr<ID3D11ShaderResourceView> GetPointShadowCube() { return _pointShadowCube; } // 포인트 큐브 그림자 (t10)
	...
	void SetPointShadowCube(ComPtr<ID3D11ShaderResourceView> srv) { _pointShadowCube = srv; }
...
private:
	...
	ComPtr<ID3D11ShaderResourceView> _pointShadowCube;
